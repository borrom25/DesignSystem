...
export const variantClasses: Record<ListItemVariant, string> = {
  ...
  danger:
    "rounded-xs text-danger-text-heavy hover:bg-danger-light-hover aria-pressed:bg-danger-light aria-pressed:text-danger-text-heavy data-[state=checked]:bg-danger-light data-[state=checked]:text-danger-text-heavy aria-disabled:text-hint data-[disabled]:text-hint",
} as const;
...
export const variantClassesNoOutline: Record<ListItemVariant, string> = {
  ...
  danger:
    "rounded-xs text-danger-text-heavy hover:bg-danger-light-hover aria-pressed:text-danger-text-heavy data-[state=checked]:text-danger-text-heavy aria-disabled:bg-generic-disabled aria-disabled:text-hint data-[disabled]:bg-generic-disabled data-[disabled]:text-hint",
} as const;
