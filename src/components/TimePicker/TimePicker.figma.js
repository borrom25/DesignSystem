// url=https://www.figma.com/design/gPjMJwL1jc8V4G6x4lZJDa/0.-%D0%94%D0%B0-%D0%BF%D0%BE%D0%BC%D0%BE%D0%B6%D0%B5%D1%82-%D0%BC%D0%BD%D0%B5-%D0%A2%D0%B5%D0%BF%D0%BB%D0%BE%D0%B2?node-id=4654-4915
// source=src/components/TimePicker/TimePicker.tsx
...
const sampleValue = textFilled && /\d{1,2}:\d{2}/.test(textFilled) ? textFilled : "12:30";
const value = hasValue ? sampleValue : "";
...
// Temporary mapping:
// Figma exposes focus/hover/typing states visually, while TimePicker runtime
// handles them through Input CSS, typed value and Popover + TimeBar interaction.
export default {
  example: figma.tsx`
    <TimePicker
      size="${size}"
      ...
      ${value ? "time={{ hours: 12, minutes: 30, seconds: 0 }}" : ""}
      ${value ? "onChangeValue={setTimeValue}" : ""}
      ${value ? "onChangeTime={setTime}" : ""}
      ${rightSlotProp}
    />
  `,
  imports: [
    'import { TimePicker, Button } from "borrom-ds-test"',
  ],
  id: "time-picker",
  metadata: {
    nestable: true,
    props: {
      ...
      timeBarRenderedInternally: true,
    },
  },
};
